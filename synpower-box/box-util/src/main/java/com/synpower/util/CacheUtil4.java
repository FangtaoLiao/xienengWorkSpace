...
/*****************************************************************************
 * @Package: com.synpower.util ClassName: CacheUtil4
 * @Description: 用于操作告警灯修改电站的告警状态
 * @version -----------------------------------------------------------------------------
 ...
 ******************************************************************************/
@Component
public class CacheUtil4 {// 和官方命令一样的格式，方便查询，具体请查询http://doc.redisfans.com/，没有写完，需要时再补充
	protected JedisPool cachePool4;

	public void setCachePool4(JedisPool cachePool4) {
		this.cachePool4 = cachePool4;
	}

	public JedisPool getCachePool4() {
		return cachePool4;
	}
