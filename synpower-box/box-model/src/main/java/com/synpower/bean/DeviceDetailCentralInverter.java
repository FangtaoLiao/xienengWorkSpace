 ...
 * @author 
 */
public class DeviceDetailCentralInverter implements Serializable {
    /**
     * key
     */
    private Integer id;
    ...
    private List<CollDevice> device;
    ...
    public List<CollDevice> getDevice() {
		return device;
	}

	public void setDevice(List<CollDevice> device) {
		this.device = device;
	}
    ...
    public boolean equals(Object that) {
        ...
        DeviceDetailCentralInverter other = (DeviceDetailCentralInverter) that;
