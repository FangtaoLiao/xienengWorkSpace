 ...
 */
@Component
public class JedisUtil2Fix60ktl {
	
	private static final Logger logger = LoggerFactory.getLogger(JedisUtil2Fix60ktl.class);
	...
	public void setShardedJedisPool(ShardedJedisPool shardedJedisPool) {
		JedisUtil2Fix60ktl.shardedJedisPool = shardedJedisPool;
		logger.info("JedisUtil2Fix60ktl is set successfully！");
	}

	static JedisUtil2Fix60ktl jedisUtil;
	...
	public void initMethod() {
		jedisUtil = new JedisUtil2Fix60ktl();
		logger.info("JedisUtil2Fix60ktl inits succefully！");
	...
	private static  ShardedJedis getShardedJedis() {
		...
		try {
			...
			logger.error("[JedisUtil2Fix60ktl] get shardedJedis false:" + e);
		} 
		return shardedJedis;
	}
	...
	public static void setMap(String key, Map<String, String> map) {
		...
		try {
			...
			logger.error("JedisUtil2Fix60ktl set map into redis error:" + e);
		} finally {
			releaseResource(shardedJedis);
		}
	}
	...
	public static Map<String, String> getMap(String key) {
		...
		try {
			...
			logger.error("JedisUtil2Fix60ktl.hkeys:{},get a exception：{}",key,e);
		} finally {
			releaseResource(shardedJedis);
		}
		return map;
