 ...
 */
@Component
public class JedisUtil4signal {
	
	private static final Logger logger = LoggerFactory.getLogger(JedisUtil4signal.class);
	...
	public void setShardedJedisPool(ShardedJedisPool shardedJedisPool) {
		JedisUtil4signal.shardedJedisPool = shardedJedisPool;
		logger.info("shardedJedisPool4signal is set successfully！");
	}

	static JedisUtil4signal jedisUtil;
	...
	public void initMethod() {
		jedisUtil = new JedisUtil4signal();
		logger.info("JedisUtil4signal inits succefully！");
	...
	private static  ShardedJedis getShardedJedis() {
		...
		try {
			...
			logger.error("[JedisUtil4signal] get shardedJedis false:" + e);
		} 
		return shardedJedis;
	}
