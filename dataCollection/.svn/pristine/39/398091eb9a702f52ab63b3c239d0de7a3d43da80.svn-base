 ...
 * @Description: 复写DailyRollingFileAppender，实现滚动限制日志文件数量功能
 * @version
 *-----------------------------------------------------------------------------
 *     VERSION           TIME                BY           CHANGE/COMMENT
 *-----------------------------------------------------------------------------
 *      1.0    2017年11月22日上午11:31:08   SP0010             create
 *-----------------------------------------------------------------------------
...
public class MyDailyRollingFileAppender extends DailyRollingFileAppender {
    ...
    private String getDateStr(File file) {
        ...
        return file.getName().replaceFirst(new File(fileName).getName(), "");
    }
